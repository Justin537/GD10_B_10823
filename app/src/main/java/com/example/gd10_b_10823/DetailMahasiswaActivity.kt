package com.example.gd10_b_10823
...
import com.example.gd10_b_10823.databinding.ActivityDetailMahasiswaBinding
...
class DetailMahasiswaActivity : AppCompatActivity() {
    ...
    fun deleteData(nim:String){
        ...
        builder.setMessage("Anda Yakin mau hapus?? Saya ngga yakin loh, masa ?.")
            .setCancelable(false)
            .setPositiveButton("Ya, Hapus Aja!, yaudah"){dialog, id->
                doDeleteData(nim)
            }
            .setNegativeButton("Tidak, Masih sayang dataku, aku nggak :v"){dialog,id ->
                    dialog.dismiss()
    }
